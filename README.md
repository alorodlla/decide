[![Build Status](https://travis-ci.com/alorodlla/decide.svg?branch=master)](https://travis-ci.com/alorodlla/decide)

Plataforma voto electrónico educativa
=====================================

El objetivo principal de este proyecto es implementar una plataforma de voto
